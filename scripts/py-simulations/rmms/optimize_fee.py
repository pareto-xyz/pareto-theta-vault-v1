...
def returnErrors(
    ...
    np.random.seed()
    t, gbm = generateGBM(
        time_horizon, drift, volatility, initial_price, timestep_size)
...
def findOptimalFee(
    ...
    # sol = minimize_scalar(
    #   ErrorFromFee, bracket=(0.0001, 0.15), method='Golden', tol = 0.005)
