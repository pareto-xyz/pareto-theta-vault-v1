/**
 * Utilities for assertions on BigNum's, which requre converting to string.
 */
...
/**
 * Convenience method to assert that the value of left operand is greater than
 * then value of the right operand
 * --
...
/**
 * Convenience method to assert that the value of left operand is greater
 * than or equal then value of the right operand
 * --
 * @param aBN The left operand BN.js instance
 * @param bBN The right operand BN.js instance
 */
...
/**
 * Convenience method to assert that the value of left operand is less than
 * then value of the right operand
 * --
 * @param aBN The left operand BN.js instance
 * @param bBN The right operand BN.js instance
